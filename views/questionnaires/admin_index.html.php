...
>
	...
	<div class="top-actions">
		<?= $this->html->link($t('questionnaire'), ['action' => 'add'], ['class' => 'button add']) ?>
	</div>
		...
		<table>
			...
			<tbody>
				...
				<tr>
					<td class="user">
						<?= $this->user->link($user) ?>
					<td><?= count($item->positions) ?>
					<td class="flag"><i class="material-icons"><?= (!empty($item->note) ? 'done' : '') ?></i>
